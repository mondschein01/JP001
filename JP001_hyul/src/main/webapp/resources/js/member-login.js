...
function clickSubmitBtn(obj) {
    ...
    if (obj.value === "아이디 찾기") {
        url = "/JP001_hyul/resources/jsp/member-find-id.jsp";
        method = "POST";
    }
    else if (obj.value === "비밀번호 찾기") {
        url = "/JP001_hyul/resources/jsp/member-find-pw.jsp";
        method = "POST";
    }
	else if (obj.value === "로그인") {
        url = "/JP001_hyul/member/login";
        method = "POST";
		chk_isValidateOk = chk_validate();
    }
    else {
        return;
    }
